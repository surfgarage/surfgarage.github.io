...
<template>
  <div :class="['contact-links', onlyIcons ? 'contact-links--only-icons' : '' ]">
    ...
    >
      ...
      <span v-if="!onlyIcons">+34631356939</span>
    </a>
    <a
    ...
    <div v-if="!onlyIcons" class="contact-links__link contact-links__link--language">
      <language class="contact-links__icon contact-links__icon--language"/>
      <LanguageSwitcher class="contact-links__language-switcher" :showLanguageName="true"/>
    </div>
